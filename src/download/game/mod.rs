...
pub trait Zipped {
    async fn download(urls: Vec<String>, game_path: String, progress: impl Fn(u64, u64, u64) + Send + Sync + 'static, cancel_token: Option<Arc<AtomicBool>>) -> bool;
    async fn patch(url: String, game_path: String, progress: impl Fn(u64, u64, u64) + Send + Sync + 'static) -> bool;
    async fn repair_game(res_list: String, game_path: String, is_fast: bool, progress: impl Fn(u64, u64, u64) + Send + Sync + 'static) -> bool;
}
